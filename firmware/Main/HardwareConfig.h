...
// Enables the ArduinoOTA service. It allows flashing over WiFi and enters an
// emergency mode if a crashloop is detected. Comming soon features
//#define USE_ARDUINO_OTA
// defines the time after which the crash loop detection assumes the operation
// is stable
